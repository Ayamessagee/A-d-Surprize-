...
function createFloatingElement(symbol, className){
    ...
    el.style.left = Math.random()*100 + 'vw'; // موضع أفقي عشوائي
...
// إنشاء عدد أولي من القلوب والنجوم
for(let i=0;i<40;i++){
    setTimeout(()=>createFloatingElement('❤','heart'), i*200);
    setTimeout(()=>createFloatingElement('★','star'), i*300);
}
